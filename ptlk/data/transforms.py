...
#     def __call__(self,tensor):
#         cloud0 = tensor.numpy()
#         cloud1=pcl.PointCloud.make_voxel_grid_filter(cloud0)
#         pcl.VoxelGridFilter.set_leaf_size(cloud1, 200.0, 200.0, 200.0)
#         cloud2=pcl.VoxelGridFilter.filter(cloud1)
#
# #        cloud1 = pcl.ApproximateVoxelGrid()
# #        pcl.ApproximateVoxelGrid.set_InputCloud(cloud1, cloud0)
# #        pcl.ApproximateVoxelGrid.set_leaf_size(cloud1, 200.0, 200.0, 200.0)
# #        cloud2 = pcl.ApproximateVoxelGrid.filter(cloud1)
#         out = torch.from_numpy(cloud2)
#
#         return out
    def __call__(self,points, radius=1.0):
        """ input is Nx3 points.
